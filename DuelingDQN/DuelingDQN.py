...
def train():
    ...
    for i_episode in range(1, n_episodes + 1):
        ...
        if i_episode % print_interval == 0:
            ...
            torch.save(agent.qnetwork_local.state_dict(), f"checkpoints/duelingdqn_model_{i_episode}.pt")
    ...
    plt.savefig('duelingdqn_rewards.png')
...
def test():
    ...
    last_episode = 1000 
    agent.qnetwork_local.load_state_dict(torch.load(f"checkpoints/duelingdqn_model_{last_episode}.pt"))
